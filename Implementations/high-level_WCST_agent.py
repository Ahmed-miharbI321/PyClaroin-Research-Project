...
class RuleChoice:
    ...
    def choose_rule(self):
        ...
        # Model certainty.
        if any(1 in tup for tup in self.rule_prob_comp): # If any one of the probabilities in the rule, probability tuple has a 100% probability of being correct
        ...
        # Model frustration.
        elif self.incorrect_counter >=2: # If the testee has two or more incorrect answers in a row
...
print("Model perseveration errors:", model.perseverative_errors)
print("-" * 50)
